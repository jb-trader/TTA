#!/usr/bin/env python3
"""
Time Trends Auto (TTA v1.0) by jb-trader
...
# ============================================================================
st.set_page_config(
    page_title="Time Trends Auto (TTA v1.0) by jb-trader",
    page_icon="🎱",
    layout="wide",
...
def main():
    ...
    st.markdown("# 🎱 Time Trends Auto (TTA v1.0) <span style='font-size: 18px; font-style: italic; color: blue;'>by jb-trader</span>", unsafe_allow_html=True)
...
- `r_squared` - Consistency (0-1)
        ...
        if tracker_df.empty:
            ...
            def select_year(year):
                ...
                year_end = min(max_date, date_type(year, 12, 31))
                st.session_state['tracker_start_input'] = year_start
                st.session_state['tracker_end_input'] = year_end
                st.session_state['selected_year'] = year
            
            def clear_year_selection():
                st.session_state['selected_year'] = None
            ...
            with date_col1:
                start_date = st.date_input(
                    ...
                    on_change=clear_year_selection
                )
